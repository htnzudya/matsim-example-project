...
# Default (23g/4g): bei 14g lief die 10pct-Population mit den SAV-DRT-Flotten
...
# Zahl. 23g gewaehlt fuer die 25pct-Population auf einem 32GB-Gesamtsystem mit
# .wslconfig memory=28g (WSL-eigener Overhead: Metaspace/Thread-Stacks/
# Direct-Memory/Linux selbst braucht die verbleibenden ~5g) UND 4GB fest fuer
# Windows reserviert - bei mehr Gesamt-RAM entsprechend hochsetzbar.
set -euo pipefail
cd "$(dirname "$0")/.."

JAVA_XMX="${JAVA_XMX:-23g}"
